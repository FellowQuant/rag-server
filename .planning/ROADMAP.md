...
- [ ] **Phase 7: Pip Package & Claude Code Auto-Config** - `pip install fellowquant-rag` with auto-configured MCP server
...
| 7. Pip Package & Claude Code Auto-Config | 0/3 | Planned | |
